    ...
    return (
        <section>
            ...
            <div className="mrktdata-wrap">
                ...
                <h2 className="mrktdata-header">Market Data</h2>
            ...
            <div className="orderstream-wrap">
                ...
                <h2 className="mrktdata-header">Order Stream</h2>
            ...
            <div className="tradestream-wrap">
                <h2 className="mrktdata-header">Trade Stream</h2>
                <div className="stream-table-wrap">
                    <table>
                        <tbody>
                            <tr>
